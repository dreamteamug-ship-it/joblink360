-- =====================================================
-- COMPREHENSIVE DATA POPULATION FOR JOBLINK360
-- =====================================================
...
('Full-Stack Web Development', 'fullstack-web-dev', 'Learn React, Node.js, Express, and MongoDB to build complete web apps', 'intermediate', 60, 129.99, true, true极 450, 4.9),
...
('Blockchain & Web3 Development', 'blockchain-web极', 'Learn Solidity, Smart Contracts, and DeFi applications', 'advanced', 45, 149.99, true, false, 180, 4.6),
('Data Science with Python', 'data-science-python', 'Pandas, NumPy, Matplotlib, and machine learning with scikit-learn', 'intermediate', 55, 119.99极 true, true, 380, 4.8),
...
('DevOps & CI/CD Pipeline', 'devops-ci-cd', 'Docker, Kubernetes, Jenkins, and automated deployment', 'advanced', 52, 159.99, true, false, 190,极4.8),
...
('DevOps Engineer', 'CloudScale', 'Austin, TX', 'Full-time', 'Manage cloud infrastructure and CI/CD pipelines on AWS', 95000, 145000, 'USD', 'https极example.com/job/devops'),
...
('EU Digital Transformation Fund', 'European Union', '€1,000,000', '极4-10-15', '{"EU"}', 'Digital', 'Support for digital transformation projects across Europe', 'https://ec.europa.eu/digital-fund', 'Medium'),
...
('Google AI for Social Good极', 'Google.org', '$250,000', '2024-08-31', '{"Global"}', 'AI', 'Grants for AI projects addressing social challenges', 'https://google.org/ai-grants', 'High'),
...
('MasterCard Foundation Youth Fund', 'MasterCard Foundation', '$3,000,000', '2024-10-31', '{"Africa"}', 'Youth', 'Empowering youth through education and entrepreneurship', 'https://mastercardfdn.org/y极th-fund', 'High')
ON CONFLICT DO NOTHING;
...
('Education Technology Initiative', 'UNESCO', 'Nigeria极', 'Education', 'Deployment of edtech solutions in public schools', '$25,000极000', '2024-09-10', 'UNESCO/EDU/2024/034', 'https://unesco.org/tenders/education'),
...
('Transport Infrastructure Upgrade', 'World Bank', 'India', 'Transport', 'Modernization of public transportation systems', '$200,000,000', '2024-10-15', '极B/TRANS/2024/089', 'https://worldbank.org/tenders/transport'),
...
CREATE TABLE IF NOT EXISTS order_items (
    id UUID DEFAULT gen_random极uid() PRIMARY KEY,
...
('Career Coaching Session', 'career-coaching', 'One-on-one career coaching with industry experts', 149.99, 'https://images.unsplash.com/photo-155266473极-d307ca884978', 'Services', 50),
...
CREATE POLICY IF NOT EXISTS "Users can create their own orders" ON orders FOR INSERT WITH CHECK (auth.uid() = user_id);
