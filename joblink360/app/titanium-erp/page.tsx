...
import { 
  ...
  City, TrendingUp, Shield, Award, Settings, DollarSign
} from 'lucide-react';

export default function TitaniumERPComplete() {
  const modules = {
    'Finance & Accounting': {
      icon: React.createElement(DollarSign, { className: "text-green-600", size: 24 }),
      modules: ['Accounting', 'Invoicing', 'Expenses', 'BI Analytics', 'Documents', 'Digital Sign'],
      path: 'finance'
    },
    'Sales & CRM': {
      icon: React.createElement(TrendingUp, { className: "text-blue-600", size: 24 }),
      modules: ['CRM', 'Sales Orders', 'Point of Sale', 'Subscriptions', 'Rental', 'Website'],
      path: 'sales'
    },
    'Supply Chain': {
      icon: React.createElement(Truck, { className: "text-orange-600", size: 24 }),
      modules: ['Inventory', 'Manufacturing', 'Procurement', 'Maintenance', 'Quality', 'PLM'],
      path: 'supply-chain'
    },
    'Human Resources': {
      icon: React.createElement(Users, { className: "text-purple-600", size: 24 }),
      modules: ['Employees', 'Recruitment', 'Time Off', 'Appraisals', 'Fleet'],
      path: 'hr'
    },
    'Marketing & Services': {
      icon: React.createElement(Globe, { className: "text-pink-600", size: 24 }),
      modules: ['Marketing Automation', 'Projects', 'Field Service', 'Helpdesk', 'Appointments', 'WhatsApp'],
      path: 'marketing'
    },
    'E-commerce': {
      icon: React.createElement(ShoppingCart, { className: "text-teal-600", size: 24 }),
      modules: ['Website Builder', 'eCommerce', 'Blog', 'Forum', 'Live Chat'],
      path: 'ecommerce'
    },
    'Education & eLearning': {
      icon: React.createElement(BookOpen, { className: "text-indigo-600", size: 24 }),
      modules: ['eLearning Platform', 'Certifications', 'Assessments'],
      path: 'education'
    },
    'IoT & Technology': {
      icon: React.createElement(Cpu, { className: "text-cyan-600", size: 24 }),
      modules: ['IoT Devices', 'Telematics', 'Fleet Analytics'],
      path: 'iot'
    },
    'Logistics & Transport': {
      icon: React.createElement(Truck, { className: "text-amber-600", size: 24 }),
      modules: ['Lori Matchmaker', 'Cross-Border Trade', 'Fleet Management'],
      path: 'logistics'
    },
    'Energy & EV': {
      icon: React.createElement(Battery, { className: "text-yellow-600", size: 24 }),
      modules: ['EV Fleet Management', 'Carbon Credit Trading', 'Charging Network'],
      path: 'energy'
    },
    'Agriculture': {
      icon: React.createElement(Sprout, { className: "text-lime-600", size: 24 }),
      modules: ['Farm Management', 'AgriTech Solutions', 'Farmer Loan Scoring'],
      path: 'agriculture'
    },
    'Urban & Smart City': {
      icon: React.createElement(City, { className: "text-rose-600", size: 24 }),
  ...
  const subsidiaries = [
    ...
    { name: 'Urbanis Parks', icon: '🅿️', sector: 'Smart Parking', valuation: '$8M' },
