        ...
        <div className="bg-zinc-900 border border-zinc-800 p-8">
          ...
          <div className="space-y-6">
            ...
            <div className="w-full bg-zinc-800 h-1">
              <div className="bg-emerald-500 h-full" style={{ width: activeStats.roi.replace('%', '') + '%' }}></div>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-[10px] text-zinc-500 uppercase">Risk Assessment</span>
              <span className={	ext-[10px] font-bold uppercase }>{activeStats.risk}</span>
            </div>
          </div>
        </div>

        {/* NDVI Satellite Insight */}
