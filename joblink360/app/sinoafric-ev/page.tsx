...
export default function SinoAfricEVPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-green-900 to-green-700 text-white py-20">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">SinoAfric EV</h1>
          <p className="text-xl text-green-200 max-w-2xl">
            Powered by Titanium ERP | Amanda AI Integration | 26 African Countries
          </p>
          <div className="mt-8 flex gap-4">
            <button className="px-6 py-3 bg-white text-green-900 rounded-lg font-semibold hover:shadow-lg transition">
              Get Started
            </button>
