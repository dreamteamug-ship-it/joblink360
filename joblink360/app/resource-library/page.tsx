...
import { 
  FileText, Video, BookOpen, Download, Search, Filter, 
  FolderOpen, Users, Briefcase, TrendingUp, Award,
  Crown, Star, Bookmark, Share2, Eye, Clock, ArrowLeft
} from 'lucide-react';
...
export default function ResourceLibrary() {
  ...
  const categories = [
    { id: 'all', name: 'All Resources', icon: <FolderOpen size={16} />, count: 12 },
    { id: 'erp', name: 'ERP', icon: <Briefcase size={16} />, count: 2 },
    { id: 'ai', name: 'AI & Intelligence', icon: <Brain size={16} />, count: 2 },
    { id: 'logistics', name: 'Logistics', icon: <Truck size={16} />, count: 2 },
    { id: 'hr', name: 'HR & Recruitment', icon: <Users size={16} />, count: 1 },
    { id: 'ev', name: 'EV Mobility', icon: <Car size={16} />, count: 1 },
    { id: 'agriculture', name: 'Agriculture', icon: <Sprout size={16} />, count: 1 },
...
import { PlayCircle, Brain, Truck, Car, Sprout, DollarSign } from 'lucide-react';
